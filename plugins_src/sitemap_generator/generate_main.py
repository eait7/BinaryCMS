...
func (p *SitemapGeneratorPlugin) generateSitemapXML() string {
	...
	if err == nil {
		defer cmsDB.Close()
		// Only querying pages for now. Adjust if posts exist.
...
func (p *SitemapGeneratorPlugin) renderDashboard() string {
	...
	<div class="row row-cards mb-3">
		...
		<div class="col-sm-4"><div class="card"><div class="card-body"><div class="subheader">Sitemap URL</div><div class="mt-2"><a href="/sitemap.xml" target="_blank" class="btn btn-sm btn-ghost-primary">View sitemap.xml &nearr;</a></div></div></div></div>
	</div>
	...
	<div class="row row-cards">
		...
		<div class="col-lg-4">
			<div class="card mb-3">
				...
				<div class="card-body">
					<form method="POST" action="/admin/plugin/sitemap-generator">
