...
func seedDefaults(db *sql.DB) {
	defaults := map[string]string{
		"site_title":       "Go CMS",
		"site_tagline":     "A fast, dynamic Go Content Management System",
		"site_logo_url":    "",
		"custom_footer":    "© 2026 Go CMS. All rights reserved.",
		"homepage_type":    "posts",
		"homepage_page_id": "0",
		...
		"footer_brand_text":  "The fast, flexible, open-source CMS. Free forever, powered by Go.",
